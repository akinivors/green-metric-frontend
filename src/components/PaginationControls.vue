...
// Add reactive ref for template access
const pagination = computed(() => props.pagination)

const currentPage = computed(() => props.pagination?.number ?? 0)
const totalPages = computed(() => props.pagination?.totalPages ?? 0)
const totalItems = computed(() => props.pagination?.totalElements ?? 0)
const pageSize = computed(() => props.pagination?.size ?? 10)

const isFirstPage = computed(() => currentPage.value === 0)
const isLastPage = computed(() => currentPage.value === totalPages.value - 1)

const itemRangeStart = computed(() => currentPage.value * pageSize.value + 1)
